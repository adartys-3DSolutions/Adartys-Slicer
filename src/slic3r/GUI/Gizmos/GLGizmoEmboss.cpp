...
void GLGizmoEmboss::draw_font_list_line()
{
    ...
    if (exist_change_in_font || !exist_stored_style)
        ImGuiWrapper::text_colored(ImGuiWrapper::COL_ADARTYS, font_text);
    else
...
void GLGizmoEmboss::draw_style_list()
{
    ...
    if (m_style_manager.exist_stored_style())
        ...
        ImGui::TextColored(ImGuiWrapper::COL_ADARTYS, "%s", title.c_str());
    ...
    const std::string& name, T& value, const T* default_value, const std::string& undo_tooltip, float undo_offset, Draw draw) const
{
    ...
    if (changed || default_value == nullptr)
        ImGuiWrapper::text_colored(ImGuiWrapper::COL_ADARTYS, name);
    else
...
void GLGizmoEmboss::init_icons()
{
    ...
    std::vector<std::string>
        filenames{"edit_button.svg",
                  ...
                  "search.svg",
                  "open.svg",
                  "obj_warning.svg",   // ADARTYS: use obj_warning instead exclamation. exclamation is not compatible with low res
