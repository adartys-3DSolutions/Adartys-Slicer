...
bool GLGizmoRotate::on_mouse(const wxMouseEvent& mouse_event) { return use_grabbers(mouse_event); }
...
void GLGizmoRotate::on_start_dragging() { init_data_from_selection(m_parent.get_selection()); }
...
void GLGizmoRotate::on_render()
{
    ...
    if (shader != nullptr) {
        ...
        // ADARTYS dont use axis color on line because they are not on same direction with axis
