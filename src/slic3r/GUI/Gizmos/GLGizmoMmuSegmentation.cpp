...
void GLGizmoMmuSegmentation::on_render_input_window(float x, float y, float bottom_limit)
{
...
#ifdef __APPLE__
        ImGui::PushStyleColor(ImGuiCol_FrameBg, ImGuiWrapper::COL_ADARTYS); // ADARTYS use adartys color for selected filament border
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 0.0f);
    ...
    for (int i = 0; i < tool_ids.size(); i++) {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 0.0);
        ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.f, 0.f, 0.f, 0.f)); // ADARTYS Removes button background on dark mode
        ImGui::PushStyleColor(ImGuiCol_Text,
                              ImVec4(1.f, 1.f, 1.f, 1.f)); // ADARTYS Fixes icon rendered without colors while using Light theme
        if (m_current_tool == tool_ids[i]) {
            ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(0.f, 0.59f, 0.53f, 0.25f)); // ADARTYS use adartys color for selected tool / brush
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered,
                                  ImVec4(0.f, 0.59f, 0.53f, 0.25f)); // ADARTYS use adartys color for selected tool / brush
            ImGui::PushStyleColor(ImGuiCol_ButtonActive,
                                  ImVec4(0.f, 0.59f, 0.53f, 0.30f)); // ADARTYS use adartys color for selected tool / brush
            ImGui::PushStyleColor(ImGuiCol_Border,
                                  ImGuiWrapper::COL_ADARTYS); // ADARTYS use adartys color for border on selected tool / brush
...
void GLGizmoMmuSegmentation::render_filament_remap_ui(float window_width, float max_tooltip_width)
{
    ...
    for (int src = 0; src < (int) n_extr; ++src) {
...
#ifdef __APPLE__
        ImGui::PushStyleColor(ImGuiCol_FrameBg, ImGuiWrapper::COL_ADARTYS);
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 0.0f);
        ImGui::PushStyleVar(ImGuiStyleVar_FrameRounding, 3.0);
        ...
        // Apply popup styling before BeginPopup using standard Adartys colors
