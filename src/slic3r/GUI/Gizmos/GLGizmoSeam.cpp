...
void GLGizmoSeam::on_shutdown() { m_parent.toggle_model_objects_visibility(true); }
...
std::string GLGizmoSeam::on_get_name() const { return _u8L("Seam painting"); }
...
PainterGizmoType GLGizmoSeam::get_painter_type() const { return PainterGizmoType::SEAM; }
