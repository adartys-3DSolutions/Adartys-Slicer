...
AboutDialogLogo::AboutDialogLogo(wxWindow* parent) : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("AdartysSlicer_192px.png"), wxBITMAP_TYPE_PNG);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        "<br />"
        "<font size=\"3\">",
        bgr_clr_str, text_clr_str, text_clr_str, _L("License"), _L("Adartys Slicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html", _L("GNU Affero General Public License, version 3"),
        _L("Adartys Slicer is based on OrcaSlicer, PrusaSlicer and BambuStudio"), _L("Libraries"),
                ...
                /*wxCAPTION*/ wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "AdartysSlicer_about_dark" : "AdartysSlicer_about", 125);
    ...
    // version
    {
        ...
        auto          version_string = std::string(SoftFever_VERSION); // _L("Adartys Slicer ") + " " + std::string(SoftFever_VERSION);
    ...
    text_list.push_back(_L("AdartysSlicer is based on AdartysSlicer, BambuStudio, PrusaSlicer, and SuperSlicer."));
    text_list.push_back(_L("AdartysSlicer is originally based on BambuSlicer by Bambu Lab."));
