    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(ADARTYS_PRIMARY_HOVER_HEX, (int) StateColor::Hovered | StateColor::Checked),
        std::make_pair(ADARTYS_PRIMARY_HEX, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", ADARTYS_PRIMARY_COLOR, ADARTYS_PRIMARY_COLOR};
wxString btn_confirm[10]  = {"#DFDFDF", ADARTYS_PRIMARY_COLOR, ADARTYS_PRIMARY_HOVER, ADARTYS_PRIMARY_COLOR, ADARTYS_PRIMARY_COLOR, "#6B6A6A", "#FEFEFE", "#FEFEFE", ADARTYS_PRIMARY_HOVER, ADARTYS_PRIMARY_HOVER};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", ADARTYS_PRIMARY_COLOR, ADARTYS_PRIMARY_COLOR};
