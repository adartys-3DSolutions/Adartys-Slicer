    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(ADARTYS_PRIMARY_RGB), StateColor::Pressed);
    border_color.append(wxColour(ADARTYS_PRIMARY_HOVER_RGB), StateColor::Hovered);
    border_color.append(ADARTYS_PRIMARY_HEX, StateColor::Normal);
    ...
    background_color.append(wxColour(ADARTYS_PRIMARY_RGB), StateColor::Pressed);
    background_color.append(wxColour(ADARTYS_PRIMARY_HOVER_RGB), StateColor::Hovered);
    background_color.append(ADARTYS_PRIMARY_HEX, StateColor::Normal);
