   ...
   : PopupWindow(parent, wxBORDER_NONE | wxPU_CONTAINS_CONTROLS)
{
    ...
    m_custom_camera_input_confirm->SetBackgroundColor(wxColour(ADARTYS_PRIMARY_HOVER_RGB));
    m_custom_camera_input_confirm->SetBorderColor(wxColour(ADARTYS_PRIMARY_HOVER_RGB));
...
void CameraPopup::set_custom_cam_button_state(bool state)
{
    ...
    auto stateColour = state ? wxColour(170, 0, 0) : wxColour(ADARTYS_PRIMARY_HOVER_RGB);
