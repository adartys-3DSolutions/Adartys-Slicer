    ...
    , m_max_flush_volume(Slic3r::g_max_flush_volume)
{
    ...
    {
        wxString message = _L("Adartys would re-calculate your flushing volumes every time the filaments color changed. You could disable "
                              "the auto-calculate in Adartys Slicer > Preferences");
