...
void ExtrusionCalibration::create()
{
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_RGB), StateColor::Pressed), std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_HOVER_RGB), StateColor::Hovered),
    ...
    m_button_cali->SetBorderColor({ std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Disabled), std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_RGB), StateColor::Enabled) });
    ...
    m_btn_bg_green = StateColor(std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_RGB), StateColor::Pressed), std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_HOVER_RGB), StateColor::Hovered),
        std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_RGB), StateColor::Normal));
    m_cali_cancel->SetBackgroundColor(m_btn_bg_green);
    m_cali_cancel->SetBorderColor(wxColour(ADARTYS_PRIMARY_RGB));
    ...
    m_button_save_result->SetBorderColor(wxColour(ADARTYS_PRIMARY_RGB));
