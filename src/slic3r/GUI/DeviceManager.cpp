...
wxString get_stage_string(int stage)
{
    ...
    case 3: return _L("Sweeping XY mech mode");
    case 4: return _L("Changing filament");
    case 5: return _L("M400 pause");
    case 6: return _L("Paused due to filament runout");
    case 7: return _L("Heating hotend");
    case 8: return _L("Calibrating extrusion");
    ...
    case 16: return _L("Printing was paused by the user");
    case 17: return _L("Pause of front cover falling");
    case 18: return _L("Calibrating the micro lidar");
    case 19: return _L("Calibrating extrusion flow");
    case 20: return _L("Paused due to nozzle temperature malfunction");
    case 21: return _L("Paused due to heat bed temperature malfunction");
    case 22: return _L("Filament unloading");
    case 23: return _L("Skip step pause");
    case 24: return _L("Filament loading");
    case 25: return _L("Motor noise calibration");
    case 26: return _L("Paused due to AMS lost");
    case 27: return _L("Paused due to low speed of the heat break fan");
    case 28: return _L("Paused due to chamber temperature control error");
    case 29: return _L("Cooling chamber");
    case 30: return _L("Paused by the G-code inserted by user");
    case 31: return _L("Motor noise showoff");
    case 32: return _L("Nozzle filament covered detected pause");
    case 33: return _L("Cutter error pause");
    case 34: return _L("First layer error pause");
    case 35: return _L("Nozzle clog pause");
    default:;
    }
    return "";
}
...
wxColour AmsTray::get_color() { return AmsTray::decode_color(color); }
...
{
    char buf[64];
    ::sprintf(buf, "%02X%02X%02X00000%1X%04X", this->module_id, this->module_num, this->part_id, (int) this->msg_level, this->msg_code);
...
{
    switch (module_id) {
    case MODULE_MC: return "MC";
    case MODULE_MAINBOARD: return "MainBoard";
    case MODULE_AMS: return "AMS";
    case MODULE_TH: return "TH";
    case MODULE_XCAM: return "XCam";
    default: wxString text = _L("Unknown") + wxString::Format("0x%x", (unsigned) module_id); return text;
    }
    return "";
}
...
{
    switch (level) {
    case HMS_FATAL: return _L("Fatal");
    case HMS_SERIOUS: return _L("Serious");
    case HMS_COMMON: return _L("Common");
    case HMS_INFO: return _L("Info");
...
std::string MachineObject::get_ftp_folder() { return DeviceManager::get_ftp_folder(printer_type); }
...
PrinterArch MachineObject::get_printer_arch() const { return DeviceManager::get_printer_arch(printer_type); }

std::string MachineObject::get_printer_ams_type() const { return DeviceManager::get_printer_ams_type(printer_type); }

bool MachineObject::get_printer_is_enclosed() const { return DeviceManager::get_printer_is_enclosed(printer_type); }
...
bool MachineObject::is_support_ams_mapping() { return true; }
...
bool MachineObject::is_multi_extruders() const { return m_extder_data.total_extder_count > 1; }
...
{
    switch (effect) {
    case LIGHT_EFFECT::LIGHT_EFFECT_ON: return "on";
    case LIGHT_EFFECT::LIGHT_EFFECT_OFF: return "off";
    case LIGHT_EFFECT::LIGHT_EFFECT_FLASHING: return "flashing";
...
bool MachineObject::is_in_upgrading() { return upgrade_display_state == (int) UpgradingInProgress; }

bool MachineObject::is_upgrading_avalable() { return upgrade_display_state == (int) UpgradingAvaliable; }
...
MachineObject::SdcardState MachineObject::get_sdcard_state() { return sdcard_state; }
                                                 ...
                                                 int         nozzle_temp_max)
{
    ...
    if (tag_ams_id == VIRTUAL_TRAY_ID) {
        ...
        tag_ams_id  = 255; // TODO: Adartys hack
    } else {
...
int MachineObject::command_start_calibration(bool vibration, bool bed_leveling, bool xcam_cali, bool motor_noise)
{
    if (!is_support_command_calibration()) {
        ...
        j["print"]["sequence_id"] = std::to_string(MachineObject::m_sequence_id++);
        j["print"]["option"]      = (motor_noise ? 1 << 3 : 0) + (vibration ? 1 << 2 : 0) + (bed_leveling ? 1 << 1 : 0) +
                               (xcam_cali ? 1 << 0 : 0);
        return this->publish_json(j.dump());
    }
}
...
int MachineObject::command_delete_pa_calibration(const PACalibIndexInfo& pa_calib)
{
    ...
    j["print"]["nozzle_id"]   = generate_nozzle_id(pa_calib.nozzle_volume_type, to_string_nozzle_diameter(pa_calib.nozzle_diameter))
                                  .ToStdString();
...
int MachineObject::command_get_pa_calibration_tab(const PACalibExtruderInfo& calib_info)
{
    ...
    if (calib_info.use_nozzle_volume_type)
        j["print"]["nozzle_id"] = generate_nozzle_id(calib_info.nozzle_volume_type, to_string_nozzle_diameter(calib_info.nozzle_diameter))
                                      .ToStdString();
...
{
    BOOST_LOG_TRIVIAL(info) << "command:ipcam_resolution_set"
...
int MachineObject::command_xcam_control(std::string module_name, bool on_off, std::string lvl)
{
    ...
    BOOST_LOG_TRIVIAL(info) << "command:xcam_control_set"
...
std::vector<std::string> MachineObject::get_compatible_machine() { return DeviceManager::get_compatible_machine(printer_type); }
                    ...
                    if (jj.contains("errno")) {
                        if (jj["errno"].is_number()) {
                            if (jj["errno"].get<int>() == -2) {
                                wxString text = _L(
                                    "The current chamber temperature or the target chamber temperature exceeds 45\u2103. " /* 45°C */
                                    "In order to avoid extruder clogging, low temperature filament (PLA/PETG/TPU) is not allowed to be "
                                    "loaded.");
                        ...
                        if (jj["errno"].is_number()) {
                            ...
                            if (jj["errno"].get<int>() == -2) {
                                text = _L("Low temperature filament (PLA/PETG/TPU) is loaded in the extruder. "
                                          "In order to avoid extruder clogging, it is not allowed to set the chamber temperature above "
                                          "45\u2103." /* 45°C */);
                            ...
                            if (jj.contains("nozzle_diameter")) {
                                if (nozzle_setting_hold_count > 0) {
                                    ...
                                    if (nozzle_diameter == 0.0f) {
                                        m_extder_data.extders[MAIN_NOZZLE_ID].current_nozzle_diameter = 0.0f;
                                    } else {
                                        m_extder_data.extders[MAIN_NOZZLE_ID].current_nozzle_diameter = round(nozzle_diameter * 10) / 10;
                                    }
                                }
                            }
                        } catch (...) {
                        ...
                        try {
                            if (jj.contains("ipcam")) {
                                ...
                                if (ipcam.contains("rtsp_url")) {
                                    ...
                                    liveview_local = local_rtsp_url.empty() ?
                                                         LVL_None :
                                                         local_rtsp_url == "disable" ?
                                                         LVL_Disable :
                                                         boost::algorithm::starts_with(local_rtsp_url, "rtsps") ? LVL_Rtsps : LVL_Rtsp;
                                }
                    ...
                    if (jj.contains("ams")) {
                        if (jj["ams"].contains("ams")) {
                            ...
                            if (!key_field_only) {
                                ...
                                if (ams_exist_bits != last_ams_exist_bits || tray_exist_bits != last_tray_exist_bits ||
                                    tray_is_bbl_bits != last_is_bbl_bits || tray_read_done_bits != last_read_done_bits ||
                                    ...
                                    if (it->contains("tray")) {
                                        ...
                                        for (auto tray_it = (*it)["tray"].begin(); tray_it != (*it)["tray"].end(); tray_it++) {
                                            ...
                                            if (tray_it->contains("tray_info_idx") && tray_it->contains("tray_type")) {
                                                ...
                                                std::string type = setting_id_to_type(curr_tray->setting_id,
                                            ...
                                            try {
                                                if (!ams_id.empty() && !curr_tray->id.empty()) {
                                                    ...
                                                    if (type_id < 4) {
                                                        curr_tray->is_exists = (tray_exist_bits & (1 << (ams_id_int * 4 + tray_id_int))) !=
                                                                                       0 ?
                                                                                   true :
                                                                                   false;
                                                    } else {
                                            ...
                                            auto diff      = std::chrono::duration_cast<std::chrono::milliseconds>(
                                                curr_time - extrusion_cali_set_hold_start);
                                        ...
                                        for (auto tray_it = tray_id_set.begin(); tray_it != tray_id_set.end(); tray_it++) {
                                            ...
                                            if (tray != curr_ams->trayList.end()) {
                                                ...
                                                BOOST_LOG_TRIVIAL(trace)
                                                    << "parse_json: remove ams_id=" << ams_id << ", tray_id=" << tray_id;
                                            }
                                        }
                                    }
                                }
...
#pragma endregion
                        ...
                        if (ams_id == 255 && tray_id == VIRTUAL_TRAY_ID) {
                            ...
                            if (ams_it != amsList.end()) {
                                ...
                                if (tray_it != ams_it->second->trayList.end()) {
                                    ...
                                    tray_it->second->type       = setting_id_to_type(tray_it->second->setting_id,
        ...
        if (!key_field_only) {
            if (m_active_state == Active && !module_vers.empty() && check_version_valid() && !is_camera_busy_off()) {
...
void MachineObject::set_ctt_dlg(wxString text)
{
    if (!m_set_ctt_dlg) {
        m_set_ctt_dlg        = true;
        auto print_error_dlg = new GUI::SecondaryCheckDialog(nullptr, wxID_ANY, _L("Warning"),
                                                             GUI::SecondaryCheckDialog::ButtonStyle::ONLY_CONFIRM);
...
{
    switch (type) {
    case FanType::COOLING_FAN: return "cooling_fan";
    case FanType::BIG_COOLING_FAN: return "big_cooling_fan";
    case FanType::CHAMBER_FAN: return "chamber_fan";
    default: return "";
    }
    return "";
}
...
AmsTray MachineObject::parse_vt_tray(json vtray)
{
    ...
    if (diff.count() > HOLD_TIMEOUT || diff.count() < 0 || extrusion_cali_set_tray_id != VIRTUAL_TRAY_ID) {
        if (vtray.contains("k"))
    ...
    if (print.contains("device")) {
        ...
        if (device.contains("nozzle")) {
            ...
            for (auto it = nozzle["info"].begin(); it != nozzle["info"].end(); it++) {
                ...
                if (nozzle_obj.diameter == 0.0f) {
                    nozzle_obj.diameter = 0.4f;
                }
...
bool MachineObject::is_nozzle_data_invalid()
{
    for (const auto& ext : m_extder_data.extders) {
        if (ext.current_nozzle_type == NozzleType::ntUndefine || ext.current_nozzle_diameter <= 0.0f) {
            return true;
        }
    }
    ...
    for (auto& nozzle : m_extder_data.extders) {
        ...
        if (printer_set.size() > 0) {
            ...
            BOOST_LOG_TRIVIAL(info) << __FUNCTION__ << " " << __LINE__ << " update printer preset name failed: "
                                    << "printer_type: " << printer_type << "nozzle_diameter_str" << nozzle_diameter_str;
    }
    ...
    /*for (auto vt_tray : vt_slot)*/ do {
        ...
        if (index >= m_extder_data.total_extder_count) {
            BOOST_LOG_TRIVIAL(error) << " vt_tray id map for nozzle id is not exist, index is: " << index << " nozzle count"
                                     << m_extder_data.total_extder_count;
            continue;
        }
        ...
        if (vt_tray.setting_id.size() == 8 && vt_tray.setting_id[0] == 'P' && vt_tray.nozzle_temp_min != "" &&
            ...
            if (checked_filament.find(vt_tray.setting_id) == checked_filament.end()) {
                ...
                try {
                    ...
                    std::string nozzle_diameter_str = stream.str();
                    bool        is_equation         = preset_bundle->check_filament_temp_equation_by_printer_type_and_nozzle_for_mas_tray(
                        MachineObject::get_preset_printer_model_name(this->printer_type), nozzle_diameter_str, vt_tray.setting_id,
                    ...
                    if (!is_equation) {
                        ...
                        command_ams_filament_settings(vt_id, 0, vt_tray.setting_id, preset_setting_id, vt_tray.color, vt_tray.type,
...
void DeviceManager::set_agent(NetworkAgent* agent) { m_agent = agent; }
        ...
        if (it != localMachineList.end()) {
            ...
            if (obj->dev_ip.compare(dev_ip) != 0) {
                if (connection_name.empty()) {
                    BOOST_LOG_TRIVIAL(info) << "MachineObject IP changed from " << Slic3r::GUI::wxGetApp().format_IP(obj->dev_ip) << " to "
                                            << Slic3r::GUI::wxGetApp().format_IP(dev_ip);
                    obj->dev_ip = dev_ip;
                } else {
                    if (obj->dev_connection_name.empty() || obj->dev_connection_name.compare(connection_name) == 0) {
                        BOOST_LOG_TRIVIAL(info)
                            << "MachineObject IP changed from " << Slic3r::GUI::wxGetApp().format_IP(obj->dev_ip) << " to "
                            << Slic3r::GUI::wxGetApp().format_IP(dev_ip) << " connection_name is " << connection_name;
            ...
            BOOST_LOG_TRIVIAL(info) << "SsdpDiscovery::New Machine, ip = " << Slic3r::GUI::wxGetApp().format_IP(dev_ip)
                                    << ", printer_name= " << dev_name << ", printer_type = " << printer_type_str
                                    << ", signal = " << printer_signal;
        }
...
MachineObject* DeviceManager::get_local_selected_machine() { return get_local_machine(local_selected_machine); }
...
void DeviceManager::erase_user_machine(std::string dev_id) { userMachineList.erase(dev_id); }
...
std::string DeviceManager::parse_printer_type(std::string type_str) { return get_value_from_config<std::string>(type_str, "printer_type"); }
...
std::string DeviceManager::get_ftp_folder(std::string type_str) { return get_value_from_config<std::string>(type_str, "ftp_folder"); }
...
bool DeviceManager::get_printer_is_enclosed(std::string type_str) { return get_value_from_config<bool>(type_str, "printer_is_enclosed"); }
...
void DeviceManager::check_filaments_in_blacklist(
    std::string tag_vendor, std::string tag_type, bool& in_blacklist, std::string& ac, std::string& info)
{
    std::unordered_map<std::string, wxString> blacklist_prompt =
        {{"TPU: not supported", _L("TPU is not supported by AMS.")},
         ...
         {"CF/GF: hard and brittle",
          _L("CF/GF filaments are hard and brittle, it's easy to break or get stuck in AMS, please use with caution.")}};
    ...
    if (filaments_blacklist.contains("blacklist")) {
        for (auto prohibited_filament : filaments_blacklist["blacklist"]) {
            ...
            if (prohibited_filament.contains("vendor") && prohibited_filament.contains("type") && prohibited_filament.contains("action") &&
