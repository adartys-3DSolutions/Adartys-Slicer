    ...
    , m_show_history_dialog(show)
{
    ...
    mew_btn->SetBorderColor(wxColour(ADARTYS_PRIMARY_RGB));
...
void HistoryWindow::sync_history_data() {
    ...
    for (auto& result : m_calib_results_history) {
        ...
        edit_button->SetBorderColor(wxColour(ADARTYS_PRIMARY_RGB));
    ...
    , m_new_result(result)
{
    ...
    save_btn->SetBorderColor(wxColour(ADARTYS_PRIMARY_RGB));
    ...
    , m_history_results(history_results)
{
    ...
    ok_btn->SetBorderColor(wxColour(ADARTYS_PRIMARY_RGB));
