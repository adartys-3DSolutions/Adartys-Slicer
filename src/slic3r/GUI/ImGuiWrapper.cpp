...
//{ImGui::PreferencesHoverButton , "notification_preferences_hover"},
    ...
    {ImGui::gCodeButtonIcon, "im_code"}, // ADARTYS
    {ImGui::VisibleIcon, "im_visible"},  // ADARTYS
    {ImGui::HiddenIcon, "im_hidden"},    // ADARTYS
...
const ImVec4 ImGuiWrapper::COL_GREEN_LIGHT     = {0.f, 156 / 255.f, 136 / 255.f,
                                              0.25f}; // ADARTYS used on various places like text selection bg. Replaced with adartys color
...
const ImVec4 ImGuiWrapper::COL_TOOLBAR_BG      = {250 / 255.f, 250 / 255.f, 250 / 255.f,
                                             1.f}; // ADARTYS color matches with toolbar_background.png
const ImVec4 ImGuiWrapper::COL_TOOLBAR_BG_DARK = {57 / 255.f, 60 / 255.f, 66 / 255.f,
                                                  1.f}; // ADARTYS color matches with toolbar_background_dark.png
const ImVec4 ImGuiWrapper::COL_ADARTYS         = to_ImVec4(ColorRGBA::ADARTYS());
    ...
    const std::string& bitmap_name, unsigned target_width, unsigned target_height, unsigned* outwidth, unsigned* outheight)
{
    ...
    float svg_scale = target_height != 0 ? (float) target_height / image->height :
                                           target_width != 0 ? (float) target_width / image->width : 1;
...
void ImGuiWrapper::push_combo_style(const float scale)
{
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 1.0f * scale);
        ImGui::PushStyleColor(ImGuiCol_PopupBg, ImGuiWrapper::COL_WINDOW_BG_DARK);
        ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(0.f, 150.f / 255.f, 136.f / 255.f, 0.6f)); // ADARTYS hovered item border color
        ImGui::PushStyleColor(ImGuiCol_HeaderHovered, {0.f, 0.f, 0.f, 0.f}); // ADARTYS hovered item background color
        ImGui::PushStyleColor(ImGuiCol_HeaderActive, COL_ADARTYS);
        ImGui::PushStyleColor(ImGuiCol_Header, ImVec4(0.f, 150.f / 255.f, 136.f / 255.f, 0.25f)); // ADARTYS active item background color
...
void ImGuiWrapper::init_font(bool compress)
{
    ...
    // Adartys: temp fix for Korean font
...
void ImGuiWrapper::init_style()
{
    ...
    set_color(ImGuiCol_HeaderHovered, to_ImVec4(to_rgba(ColorRGB::ADARTYS(), 0.50f))); // ADARTYS Use adartys color for headers
    set_color(ImGuiCol_HeaderActive, to_ImVec4(to_rgba(ColorRGB::ADARTYS(), 0.75f)));  // ADARTYS Use adartys color for headers

    // Slider
    set_color(ImGuiCol_SliderGrab, to_ImVec4(to_rgba(ColorRGB::ADARTYS(), 0.50f)));       // ADARTYS Use adartys color for slider thumbs
    set_color(ImGuiCol_SliderGrabActive, to_ImVec4(to_rgba(ColorRGB::ADARTYS(), 0.75f))); // ADARTYS Use adartys color for slider thumbs
