...
void AMSMaterialsSetting::create()
{
    ...
    m_btn_bg_green   = StateColor(std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_RGB), StateColor::Pressed),
    ...
    m_btn_bg_gray  = StateColor(std::pair<wxColour, int>(wxColour(206, 206, 206), StateColor::Pressed),
...
void AMSMaterialsSetting::on_select_ok(wxCommandEvent& event)
{
    ...
    if (is_virtual_tray()) {
        ...
        if (obj->cali_version >= 0) {
            ...
            select_index_info.ams_id          = 255; // TODO: Adartys hack
...
void AMSMaterialsSetting::Popup(wxString filament, wxString sn, wxString temp_min, wxString temp_max, wxString k, wxString n)
{
    ...
    std::set<std::string> printer_names =
        preset_bundle->get_printer_names_by_printer_type_and_nozzle(MachineObject::get_preset_printer_model_name(obj->printer_type),
                                                                    nozzle_diameter_str);
...
void AMSMaterialsSetting::msw_rescale() { m_clr_picker->msw_rescale(); }
