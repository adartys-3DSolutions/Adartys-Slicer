...
{
    m_button_ok->Enable();
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_HOVER_RGB), StateColor::Pressed),
                            std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_HOVER_RGB), StateColor::Hovered),
                            std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
    m_button_ok->SetBackgroundColor(btn_bg_green);
                ...
                wxCAPTION | wxCLOSE_BOX)
{
    ...
    m_test_right_msg->SetForegroundColour(wxColour(ADARTYS_PRIMARY_HOVER_RGB));
