...
PingCodeBindDialog::~PingCodeBindDialog() {
     ...
     : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Log in printer"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
 {
     ...
     m_link_Terms_title->SetForegroundColour(wxColour(ADARTYS_PRIMARY_HEX));
     ...
     m_link_privacy_title->SetForegroundColour(wxColour(ADARTYS_PRIMARY_HEX));
     ...
     m_link_notice_title->SetForegroundColour(wxColour(ADARTYS_PRIMARY_HEX));
...
UnBindMachineDialog::UnBindMachineDialog(Plater *plater /*= nullptr*/)
     : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Log out printer"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
 {
    m_tocken.reset(new int(0));
     ...
     StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_HOVER_RGB), StateColor::Hovered),
                             std::pair<wxColour, int>(wxColour(ADARTYS_PRIMARY_RGB), StateColor::Normal));
     m_button_unbind->SetBackgroundColor(btn_bg_green);
     m_button_unbind->SetBorderColor(wxColour(ADARTYS_PRIMARY_RGB));
