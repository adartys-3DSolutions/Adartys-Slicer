...
void PrintObject::prepare_infill()
{
    ...
    // Adartys: Brought this function call before the process_external_surfaces, to allow bridges over holes to expand more than
                                                     ...
                                                     const std::vector<t_config_option_key>& opt_keys)
{
    ...
    for (const t_config_option_key& opt_key : opt_keys) {
        if (opt_key == "brim_width" || opt_key == "brim_object_gap" || opt_key == "brim_type" || opt_key == "brim_ears_max_angle" ||
            ...
            if (value_changed && this->object_extruders().size() > 1) {
                ...
                steps.emplace_back(posSlice);
                   ...
                   opt_key == "internal_bridge_angle" // ADARTYS: Internal bridge angle override
                   // BBS
...
void PrintObject::detect_surfaces_type()
{
    ...
    for (size_t region_id = 0; region_id < this->num_printing_regions(); ++region_id) {
        ...
        // ==================================================================================================
        // === ADARTYS: Create a SECOND bridge layer above the first bridge layer. =============================
        // === ADARTYS: Surface is flagged as a new surface type called stInternalAfterExternalBridge ==================
        ...
        if ((this->config().enable_extra_bridge_layer.value == eblApplyToAll) ||
            ...
            // ==============================================================================================================
            // === ADARTYS: Interim workaround - for now the new stInternalAfterExternalBridge surfaace is re-classified  ==============
        ...
        // ==============================================================================================================
        // === ADARTYS: End of second external bridge layer changes  =======================================================
        // ==============================================================================================================
...
void PrintObject::bridge_over_infill()
{
            ...
            for (size_t lidx = r.begin(); lidx < r.end(); lidx++) {
                ...
                for (const LayerRegion* region : layer->regions()) {
                    ...
                    for (const Surface* s : region_internal_solids) {
                        ...
                        // Adartys: If the user has selected to always support internal overhanging regions, no matter how small
                        // skip the filtering
    ...
    auto construct_anchored_polygon = [](Polygons bridged_area, Lines anchors, const Flow& bridging_flow, double bridging_angle) {
        ...
        double   aligning_angle = -bridging_angle + PI * 0.5;
        {
            ...
            for (size_t i = 0; i < n_vlines; i++) {
                // Adartys: Make sure the line is placed in the middle of the extrusion
        ...
        for (size_t cluster_idx = r.begin(); cluster_idx < r.end(); cluster_idx++) {
            for (size_t job_idx = 0; job_idx < clustered_layers_for_threads[cluster_idx].size(); job_idx++) {
                ...
                for (const CandidateSurface& candidate : surfaces_by_layer[lidx]) {
                    ...
                    // Adartys: Keep fine details for better anchoring
    ...
    // ======================================================================================================================================
    // === ADARTYS: Create a second internal bridge layer above the first bridge layer. ========================================================
    // ======================================================================================================================================
    if (this->m_config.enable_extra_bridge_layer == eblApplyToAll || this->m_config.enable_extra_bridge_layer == eblInternalBridgeOnly) {
        ...
        // =================================================================================================================
        // === ADARTYS: Interim workaround - for now the new stSecondInternalBridge surfaces are re-classified  ===============
    ...
    // ===========================================================================================
    // === ADARTYS: End of second bridging pass =====================================================
    // ===========================================================================================
...
{
    // Adartys: updated function call for XYZ shrinkage compensation
...
// Adartys: XYZ shrinkage compensation has introduced the const Vec3d &object_shrinkage_compensation parameter to the function below
...
std::vector<unsigned int> PrintObject::object_extruders() const
{
    ...
    // Adartys: Collect extruders from all regions.
            ...
            for (size_t idx_surface_type = 0; idx_surface_type < 3; ++idx_surface_type) {
                ...
                for (int n = (type == stTop) ? int(i) - 1 : int(i) + 1;
                    ...
                    if (new_internal_solid.empty()) {
                        ...
                        // Adartys: Also use the same strategy if the user has selected to further reduce
                    ...
                    if (factor > 0.0f) {
                        ...
                        // Adartys: Also use the same strategy if the user has selected to reduce
...
void PrintObject::combine_infill()
{
    ...
    for (size_t region_id = 0; region_id < this->num_printing_regions(); ++region_id) {
        ...
        // Adartys: Limit combination of infill to up to infill_combination_max_layer_height
