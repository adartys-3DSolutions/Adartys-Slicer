...
enum class VendorType { Unknown = 0, Klipper, Marlin, Marlin_BBL };
namespace Slic3r {
...
public:
    ...
    static const char* ADARTYS_DEFAULT_BUNDLE;
    static const char* ADARTYS_DEFAULT_PRINTER_MODEL;
    static const char* ADARTYS_DEFAULT_PRINTER_VARIANT;
    static const char* ADARTYS_DEFAULT_FILAMENT;
    static const char* ADARTYS_FILAMENT_LIBRARY;
