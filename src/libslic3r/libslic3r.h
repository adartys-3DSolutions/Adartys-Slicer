...
#define SLIC3R_APP_FULL_NAME "Adartys Slicer"
#define GCODEVIEWER_APP_NAME "AdartysSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY "AdartysSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("AdartysSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
...
// Adartys todo: might be better to use 1e-5 for all, namometer resolution is not needed for 3D printing
...
// Adartys: maximum number of extruders is 64. For SEMM printers, it defines maximum filament number.
static constexpr size_t MAXIMUM_EXTRUDER_NUMBER = 64;

// Adartys: maximum line width is 5 times the nozzle diameter
