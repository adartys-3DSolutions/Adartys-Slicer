...
void PerimeterGenerator::process_classic()
{
    ...
    // Adartys: ignore precise_outer_wall if wall_sequence is not InnerOuter
    ...
    for (size_t order_idx = 0; order_idx < surface_order.size(); order_idx++) {
        ...
        if (loop_number >= 0) {
            ...
            if (is_outer_wall_first ||
                ...
                entities.reverse();
            // Adartys: sandwich mode. Apply after 1st layer.
...
// Adartys: sacrificial bridge layer algorithm ported from SuperSlicer
                    ...
                    if (!unsupported.empty()) {
                        ...
                        if (!bridgeable.empty()) {
                            ...
                            if (/*this->config->counterbore_hole_bridging.value == chbNoPeri || */ this->config->counterbore_hole_bridging
                                ...
                                // bridgeable_simplified), perimeter_spacing * 3 / 2); ExPolygons unbridgeable = intersection_ex(unsupported,
                                // diff_ex(unsupported_filtered, offset_ex(bridgeable_simplified, ext_perimeter_width / 2))); unbridgeable =
                                // offset2_ex(unbridgeable, -ext_perimeter_width, ext_perimeter_width);
...
void PerimeterGenerator::process_arachne()
{
    ...
    for (const Surface& surface : all_surfaces) {
        ...
        // Adartys: set the topmost layer to be one wall according to the config
        ...
        // Adartys: properly adjust offset for the outer wall if precise_outer_wall is enabled.
        ...
        if (inner_loop_number >= 0) {
            ...
            if (!top_expolygons.empty()) {
                ...
                // ADARTYS: skip if the top surface area is smaller than "min_width_top_surface"
                ...
                // ADARTYS: Expand the polygon with half the perimeter width in addition to the contracted amount,
            ...
            if (ordered_extrusions.size() > 2) { // 3 walls minimum needed to do inner outer inner ordering
                ...
                while (position < reordered_extrusions.size()) {
                    ...
                    if (outer > -1 && first_internal > -1 &&
                        ...
                        inner_outer_extrusions.resize(max_internal - position +
