...
Generator::Generator(const PrintObject& print_object, const std::function<void()>& throw_on_cancel_callback)
{
    ...
    // Adartys: fix lightning infill divide by zero when infill line width is set to 0.
                     ...
                     float                        density)
{
    ...
    // higher density lightning makes support harder, more time-consuming on computing and printing, but more reliable on supporting
    // overhangs lower density lightning performs opposite
